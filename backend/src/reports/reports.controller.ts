...
export class ReportsController {
  ...
  getSalesReport(
    ...
    return this.dashboardService.getSalesReport(startDate, endDate, car);
  }
  ...
  getExpenseReport(
    ...
    return this.dashboardService.getExpenseReport(startDate, endDate, car);
  }
  ...
  getProfitReport(
    ...
    return this.dashboardService.getProfitReport(startDate, endDate, car);
  }
}
